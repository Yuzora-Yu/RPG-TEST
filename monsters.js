...
const MONSTER_BANDS_1_200 = [
  { bandStart: 1, bandEnd: 5, offsetType: 'low_1_5', monsters: [
    m({id:100001,name:'ジェリー',race:'粘体',rank:1,minF:1,hp:10,mp:0,atk:9,def:5,spd:3,mag:4,mdef:3,gold:14,exp:14,actCount:1,acts:[act(1,70),act(10,15),act(2,15)],elmRes:{火:-30,雷:-20}}),
    m({id:100002,name:'やみこうもり',race:'獣',rank:1,minF:1,hp:9,mp:2,atk:11,def:6,spd:4,mag:8,mdef:3,gold:18,exp:16,actCount:1,acts:[act(1,70),act(14,20),act(61,10)],elmRes:{光:-30,雷:-20}}),
    m({id:100003,name:'ウィスプ',race:'精霊',rank:1,minF:1,hp:7,mp:3,atk:7,def:7,spd:3,mag:10,mdef:6,gold:19,exp:16,actCount:1,acts:[act(1,65),act(12,20),act(60,15)],elmRes:{火:-20,闇:-20}}),
    m({id:100004,name:'ヒールジェリー',race:'粘体',rank:1,minF:1,hp:8,mp:5,atk:5,def:3,spd:1,mag:3,mdef:8,gold:28,exp:32,actCount:1,acts:[act(1,60),act(20,25),act(2,15)],elmRes:{雷:-30,火:-20}}),
  ]},

  { bandStart: 6, bandEnd: 10, offsetType: 'low_6_10', monsters: [
    m({id:100005,name:'ホーンラビット',race:'獣',rank:6,minF:6,hp:64,mp:3,atk:16,def:7,spd:18,mag:2,mdef:4,gold:34,exp:38,actCount:1,acts:[act(1,70),act(41,15),act(49,15)],elmRes:{火:-20,闇:-10}}),
    m({id:100006,name:'ポイズンジェリー',race:'粘体',rank:6,minF:6,hp:149,mp:8,atk:14,def:9,spd:9,mag:5,mdef:5,gold:40,exp:45,actCount:1,acts:[act(1,65),act(250,20),act(701,15)],elmRes:{火:-30,雷:-20},resists:{Poison:30}}),
    m({id:100007,name:'火の小精',race:'精霊',rank:6,minF:6,hp:46,mp:17,atk:8,def:5,spd:14,mag:16,mdef:11,gold:40,exp:45,actCount:1,acts:[act(1,65),act(10,20),act(15,15)],elmRes:{水:-40,闇:-20}}),
    m({id:100008,name:'さまよう鎧',race:'無生物',rank:6,minF:6,hp:156,mp:0,atk:18,def:14,spd:4,mag:6,mdef:8,gold:55,exp:55,actCount:1,acts:[act(1,70),act(44,20),act(2,10)],elmRes:{雷:-30,水:-10},resists:{Poison:30}}),
    m({id:100009,name:'錆びた鎧兵',race:'無生物',rank:6,minF:6,hp:191,mp:0,atk:14,def:17,spd:5,mag:3,mdef:9,gold:90,exp:85,actCount:2,isElite:true,acts:[act(1,60),act(44,25),act(51,15)],drops:{normal:{id:2,rate:5},rare:{id:105,rate:1}},elmRes:{雷:-30,水:-20},resists:{Poison:40}}),
  ]},

  { bandStart: 11, bandEnd: 15, monsters: [
    m({id:100010,name:'マッドゴーレム',race:'無生物',rank:11,minF:11,hp:191,mp:0,atk:24,def:14,spd:3,mag:2,mdef:6,gold:117,exp:102,actCount:1,acts:[act(1,70),act(101,15),act(60,15)],elmRes:{水:-20,雷:-30},resists:{Poison:30}}),
    m({id:100011,name:'ブラックバット',race:'獣',rank:11,minF:11,hp:71,mp:8,atk:19,def:4,spd:19,mag:18,mdef:3,gold:117,exp:102,actCount:1,acts:[act(1,70),act(14,20),act(703,10)],elmRes:{光:-30,雷:-20}}),
    m({id:100012,name:'アクアスライム',race:'粘体',rank:11,minF:11,hp:174,mp:12,atk:19,def:8,spd:9,mag:20,mdef:8,gold:117,exp:102,actCount:1,acts:[act(1,65),act(11,20),act(12,15)],elmRes:{雷:-30,火:-10}}),
    m({id:100013,name:'グラスウルフ',race:'獣',rank:11,minF:11,hp:180,mp:0,atk:28,def:6,spd:19,mag:2,mdef:3,gold:117,exp:102,actCount:1,acts:[act(1,70),act(41,20),act(60,10)],elmRes:{火:-20,光:-10}}),
  ]},

  { bandStart: 16, bandEnd: 20, monsters: [
    m({id:100014,name:'いたずらバット',race:'魔族',rank:16,minF:16,hp:196,mp:17,atk:20,def:7,spd:16,mag:29,mdef:10,gold:148,exp:136,actCount:1,acts:[act(1,65),act(14,20),act(60,15)],elmRes:{光:-30,雷:-10}}),
    m({id:100015,name:'ブロンズナイト',race:'無生物',rank:16,minF:16,hp:206,mp:0,atk:28,def:15,spd:5,mag:3,mdef:11,gold:148,exp:136,actCount:1,acts:[act(1,65),act(40,15),act(44,15),act(2,5)],elmRes:{雷:-30,水:-20},resists:{Poison:40}}),
    m({id:100016,name:'ゴースト',race:'死霊',rank:16,minF:16,hp:168,mp:17,atk:4,def:4,spd:16,mag:29,mdef:13,gold:148,exp:136,actCount:1,acts:[act(1,60),act(10,15),act(14,20),act(61,5)],elmRes:{光:-40,火:-10},resists:{Poison:30}}),
    m({id:100017,name:'いやしの芽',race:'植物',rank:16,minF:16,hp:191,mp:23,atk:4,def:7,spd:5,mag:28,mdef:11,gold:148,exp:136,actCount:1,acts:[act(1,55),act(20,25),act(51,10),act(701,10)],elmRes:{火:-40,闇:-20},resists:{Poison:30}}),
    m({id:100018,name:'ブロンズリーダー',race:'無生物',rank:16,minF:16,hp:251,mp:0,atk:18,def:17,spd:6,mag:2,mdef:14,gold:244,exp:224,actCount:2,isElite:true,acts:[act(1,55),act(44,20),act(101,15),act(51,10)],drops:{normal:{id:3,rate:5},rare:{id:102,rate:1}},elmRes:{雷:-30,水:-20},resists:{Poison:50}}),
  ]},

  { bandStart: 21, bandEnd: 25, monsters: [
    m({id:100019,name:'サンドリザード',race:'竜',rank:21,minF:21,hp:234,mp:0,atk:40,def:17,spd:12,mag:3,mdef:7,gold:298,exp:272,actCount:1,acts:[act(1,65),act(43,15),act(601,20)],elmRes:{水:-30,雷:-20},resists:{Poison:20}}),
    m({id:100020,name:'ヘルラビット',race:'獣',rank:21,minF:21,hp:211,mp:0,atk:38,def:7,spd:31,mag:3,mdef:3,gold:298,exp:272,actCount:1,acts:[act(1,65),act(41,20),act(49,15)],elmRes:{火:-20,闇:-10}}),
    m({id:100021,name:'呪いの霊魂',race:'死霊',rank:21,minF:21,hp:191,mp:23,atk:5,def:7,spd:31,mag:34,mdef:13,gold:298,exp:272,actCount:1,acts:[act(1,60),act(14,20),act(61,10),act(703,10)],elmRes:{光:-40,雷:-20},resists:{Poison:30}}),
    m({id:100022,name:'マンドラゴラ',race:'植物',rank:21,minF:21,hp:216,mp:23,atk:14,def:12,spd:10,mag:33,mdef:9,gold:298,exp:272,actCount:1,acts:[act(1,60),act(701,15),act(60,15),act(20,10)],elmRes:{火:-30,風:-20},resists:{Poison:40}}),
  ]},

  { bandStart: 26, bandEnd: 30, monsters: [
    m({id:100023,name:'アーミーウルフ',race:'獣',rank:26,minF:26,hp:246,mp:0,atk:47,def:14,spd:39,mag:4,mdef:3,gold:209,exp:197,actCount:1,acts:[act(1,65),act(41,20),act(101,15)],elmRes:{火:-20,光:-10}}),
    m({id:100024,name:'アイアンジェリー',race:'粘体',rank:26,minF:26,hp:259,mp:7,atk:33,def:23,spd:10,mag:4,mdef:14,gold:209,exp:197,actCount:1,acts:[act(1,65),act(44,15),act(2,20)],elmRes:{雷:-30,火:-20},resists:{Poison:40}}),
    m({id:100025,name:'フレイムスプライト',race:'精霊',rank:26,minF:26,hp:216,mp:35,atk:7,def:8,spd:29,mag:40,mdef:12,gold:209,exp:197,actCount:1,acts:[act(1,60),act(10,20),act(15,20)],elmRes:{水:-50,闇:-20}}),
    m({id:100026,name:'ヒールスポア',race:'植物',rank:26,minF:26,hp:229,mp:43,atk:7,def:12,spd:10,mag:36,mdef:14,gold:209,exp:197,actCount:1,acts:[act(1,55),act(20,25),act(701,10),act(51,10)],elmRes:{火:-40,風:-20},resists:{Poison:40}}),
    m({id:100027,name:'群狼隊長',race:'獣',rank:26,minF:26,hp:312,mp:0,atk:31,def:20,spd:43,mag:3,mdef:7,gold:345,exp:325,actCount:2,isElite:true,acts:[act(1,55),act(41,20),act(101,15),act(703,10)],drops:{normal:{id:5,rate:2},rare:{id:104,rate:1}},elmRes:{火:-20,光:-20}}),
  ]},

  { bandStart: 31, bandEnd: 35, monsters: [
    m({id:100028,name:'キラーバット',race:'獣',rank:31,minF:31,hp:277,mp:15,atk:47,def:14,spd:36,mag:25,mdef:7,gold:246,exp:210,actCount:1,acts:[act(1,60),act(46,20),act(14,15),act(703,5)],elmRes:{光:-30,雷:-20}}),
    m({id:100029,name:'ルーンジェリー',race:'粘体',rank:31,minF:31,hp:318,mp:48,atk:26,def:29,spd:17,mag:56,mdef:29,gold:246,exp:210,actCount:1,acts:[act(1,60),act(10,15),act(11,15),act(16,10)],elmRes:{雷:-30,闇:-10}}),
    m({id:100030,name:'ブリーズリザード',race:'竜',rank:31,minF:31,hp:302,mp:0,atk:71,def:28,spd:36,mag:6,mdef:17,gold:246,exp:210,actCount:1,acts:[act(1,60),act(43,15),act(46,15),act(601,10)],elmRes:{雷:-30,水:-20},resists:{Poison:20}}),
    m({id:100031,name:'見習いメイジ',race:'魔族',rank:31,minF:31,hp:259,mp:48,atk:7,def:14,spd:17,mag:76,mdef:29,gold:246,exp:210,actCount:1,acts:[act(1,55),act(301,15),act(312,15),act(60,15)],elmRes:{光:-30,雷:-10}}),
  ]},

  { bandStart: 36, bandEnd: 40, monsters: [
    m({id:100032,name:'ファイアウィスプ',race:'精霊',rank:36,minF:36,hp:285,mp:55,atk:9,def:14,spd:28,mag:77,mdef:33,gold:327,exp:346,actCount:1,acts:[act(1,55),act(10,20),act(15,15),act(301,10)],elmRes:{水:-50,闇:-20}}),
    m({id:100033,name:'アクアウィスプ',race:'精霊',rank:36,minF:36,hp:285,mp:55,atk:9,def:14,spd:28,mag:77,mdef:33,gold:327,exp:346,actCount:1,acts:[act(1,55),act(11,20),act(12,10),act(303,15)],elmRes:{雷:-40,闇:-20}}),
    m({id:100034,name:'ライトウィスプ',race:'精霊',rank:36,minF:36,hp:285,mp:55,atk:9,def:14,spd:28,mag:77,mdef:33,gold:327,exp:346,actCount:1,acts:[act(1,55),act(16,20),act(13,15),act(60,10)],elmRes:{闇:-40,火:-10}}),
    m({id:100035,name:'ダークウィスプ',race:'精霊',rank:36,minF:36,hp:285,mp:55,atk:9,def:14,spd:28,mag:77,mdef:33,gold:327,exp:346,actCount:1,acts:[act(1,55),act(14,25),act(312,10),act(61,10)],elmRes:{光:-40,雷:-10}}),
    m({id:100036,name:'ウィスプナイト',race:'無生物',rank:36,minF:36,hp:387,mp:0,atk:47,def:74,spd:12,mag:5,mdef:36,gold:540,exp:571,actCount:2,isElite:true,acts:[act(1,55),act(44,20),act(102,15),act(51,10)],drops:{normal:{id:13,rate:3},rare:{id:105,rate:1}},elmRes:{雷:-30,水:-20},resists:{Poison:50}}),
  ]},

  { bandStart: 41, bandEnd: 45, monsters: [
    m({id:100037,name:'バンパイア',race:'死霊',rank:41,minF:41,hp:324,mp:41,atk:56,def:19,spd:40,mag:50,mdef:36,gold:587,exp:587,actCount:1,acts:[act(1,55),act(47,20),act(14,15),act(703,10)],elmRes:{光:-50,雷:-20},resists:{Poison:30}}),
    m({id:100038,name:'アーマーラビット',race:'獣',rank:41,minF:41,hp:371,mp:0,atk:76,def:76,spd:31,mag:7,mdef:23,gold:587,exp:587,actCount:1,acts:[act(1,60),act(44,20),act(41,20)],elmRes:{火:-20,闇:-10}}),
    m({id:100039,name:'メイジゴースト',race:'死霊',rank:41,minF:41,hp:298,mp:57,atk:8,def:19,spd:31,mag:81,mdef:47,gold:587,exp:587,actCount:1,acts:[act(1,50),act(301,20),act(312,20),act(60,10)],elmRes:{光:-40,火:-10},resists:{Poison:40}}),
    m({id:100040,name:'アイアンウルフ',race:'獣',rank:41,minF:41,hp:354,mp:0,atk:87,def:42,spd:40,mag:7,mdef:10,gold:587,exp:587,actCount:1,acts:[act(1,55),act(41,20),act(101,15),act(46,10)],elmRes:{火:-20,光:-10}}),
  ]},

  { bandStart: 46, bandEnd: 50, monsters: [
    m({id:100041,name:'ダークソルジャー',race:'無生物',rank:46,minF:46,hp:415,mp:0,atk:89,def:89,spd:23,mag:10,mdef:50,gold:776,exp:800,actCount:1,acts:[act(1,55),act(44,20),act(102,15),act(50,10)],elmRes:{光:-30,雷:-20},resists:{Poison:50}}),
    ...
    m({id:100043,name:'フレイムヴァイン',race:'植物',rank:46,minF:46,hp:390,mp:60,atk:50,def:47,spd:23,mag:80,mdef:50,gold:776,exp:800,actCount:1,acts:[act(1,55),act(301,15),act(601,20),act(701,10)],elmRes:{水:-50,風:-20},resists:{Poison:50}}),
    ...
    m({id:100045,name:'ダークナイト',race:'無生物',rank:46,minF:46,hp:461,mp:13,atk:71,def:96,spd:31,mag:33,mdef:76,gold:1280,exp:1320,actCount:2,isElite:true,acts:[act(1,45),act(102,20),act(44,15),act(50,10),act(103,10)],drops:{normal:{id:14,rate:1},rare:{id:106,rate:0.5}},elmRes:{光:-30,雷:-20},resists:{Poison:60,Shock:20}}),
  ]},
  
    { bandStart: 51, bandEnd: 55, monsters: [
    m({id:100046,name:'機械兵士',race:'機械',rank:51,minF:51,hp:472,mp:0,atk:96,def:101,spd:39,mag:4,mdef:73,gold:950,exp:1000,actCount:1,acts:[act(1,45),act(44,15),act(102,25),act(153,15)],elmRes:{闇:20,雷:-30,水:-10},resists:{Poison:60,Shock:20}}),
    m({id:100047,name:'ブラッドウルフ',race:'獣',rank:51,minF:51,hp:415,mp:0,atk:105,def:53,spd:84,mag:4,mdef:14,gold:950,exp:1000,actCount:1,acts:[act(1,45),act(41,15),act(108,20),act(47,20)],elmRes:{風:10,火:-20,光:-20}}),
    ...
    m({id:100049,name:'ストーンジェリー',race:'粘体',rank:51,minF:51,hp:493,mp:33,atk:89,def:89,spd:24,mag:33,mdef:50,gold:950,exp:1000,actCount:1,acts:[act(1,45),act(44,15),act(150,20),act(60,20)],elmRes:{火:10,雷:-30},resists:{Poison:50}}),
  ]},

  { bandStart: 56, bandEnd: 60, monsters: [
    m({id:100050,name:'キラーナイト',race:'無生物',rank:56,minF:56,hp:493,mp:0,atk:111,def:107,spd:50,mag:6,mdef:76,gold:1150,exp:1200,actCount:1,acts:[act(1,45),act(101,15),act(102,25),act(44,15)],elmRes:{闇:20,雷:-30,光:-10},resists:{Poison:60}}),
    m({id:100051,name:'キラーラビット',race:'獣',rank:56,minF:56,hp:439,mp:0,atk:105,def:50,spd:92,mag:6,mdef:17,gold:1150,exp:1200,actCount:1,acts:[act(1,45),act(41,15),act(108,20),act(201,20)],elmRes:{風:10,火:-20}}),
  ...
  { bandStart: 61, bandEnd: 65, monsters: [
    ...
    m({id:100056,name:'アーマーリザード',race:'竜',rank:61,minF:61,hp:551,mp:0,atk:111,def:115,spd:70,mag:7,mdef:81,gold:1350,exp:1450,actCount:1,acts:[act(1,45),act(43,15),act(102,20),act(153,20)],elmRes:{火:20,水:-30},resists:{Poison:40}}),
  ...
  { bandStart: 66, bandEnd: 70, monsters: [
    m({id:100059,name:'アルリザード',race:'竜',rank:66,minF:66,hp:560,mp:40,atk:126,def:111,spd:81,mag:56,mdef:87,gold:1650,exp:1750,actCount:1,acts:[act(1,40),act(102,20),act(103,20),act(602,20)],elmRes:{水:20,雷:-30},resists:{Poison:50}}),
    ...
    m({id:100061,name:'シルフウルフ',race:'獣',rank:66,minF:66,hp:532,mp:0,atk:121,def:70,spd:105,mag:7,mdef:17,gold:1650,exp:1750,actCount:1,acts:[act(1,40),act(108,20),act(105,20),act(49,20)],elmRes:{風:20,火:-20}}),
    ...
    m({id:100063,name:'ダークバトラー強',race:'魔族',rank:66,minF:66,hp:675,mp:137,atk:105,def:115,spd:84,mag:105,mdef:98,gold:2723,exp:2888,actCount:2,isElite:true,acts:[act(1,35),act(104,25),act(116,15),act(305,15),act(57,10)],drops:{normal:{id:5,rate:3},rare:{id:102,rate:1}},elmRes:{闇:40,光:-40},resists:{Poison:50,Seal:40}}),
  ]},
  ...
  { bandStart: 71, bandEnd: 75, monsters: [
    ...
    m({id:100067,name:'バトルリザード',race:'竜',rank:71,minF:71,hp:595,mp:40,atk:136,def:101,spd:101,mag:7,mdef:94,gold:1950,exp:2100,actCount:1,acts:[act(1,40),act(102,20),act(154,20),act(603,20)],elmRes:{火:20,水:-30},resists:{Poison:50}}),
  ]},
  ...
  { bandStart: 76, bandEnd: 80, monsters: [
    ...
    m({id:100070,name:'ブレイズナイト',race:'無生物',rank:76,minF:76,hp:612,mp:53,atk:142,def:126,spd:56,mag:89,mdef:98,gold:2350,exp:2550,actCount:1,acts:[act(1,35),act(40,15),act(156,20),act(603,20),act(51,10)],elmRes:{火:30,水:-40,雷:-20},resists:{Poison:70}}),
  ...
  { bandStart: 81, bandEnd: 85, monsters: [
    ...
    m({id:100074,name:'メタルリザード',race:'竜',rank:81,minF:81,hp:726,mp:53,atk:126,def:138,spd:84,mag:7,mdef:107,gold:2800,exp:3050,actCount:1,acts:[act(1,35),act(45,15),act(153,25),act(51,25)],elmRes:{火:20,水:20,雷:-30},resists:{Poison:70}}),
    ...
    m({id:100076,name:'キラーマシン試作',race:'機械',rank:81,minF:81,hp:726,mp:0,atk:141,def:138,spd:94,mag:7,mdef:107,gold:2800,exp:3050,actCount:1,acts:[act(1,35),act(41,15),act(154,25),act(251,25)],elmRes:{闇:20,雷:-40},resists:{Poison:80,Shock:30}}),
  ]},
  ...
  { bandStart: 86, bandEnd: 90, monsters: [
    ...
    m({id:100078,name:'アビスウルフ',race:'獣',rank:86,minF:86,hp:697,mp:0,atk:142,def:111,spd:119,mag:7,mdef:25,gold:3350,exp:3650,actCount:1,acts:[act(1,35),act(108,25),act(201,20),act(703,20)],elmRes:{風:20,光:-20,火:-20}}),
    m({id:100079,name:'サンダーアーマー',race:'無生物',rank:86,minF:86,hp:726,mp:67,atk:144,def:142,spd:89,mag:7,mdef:115,gold:3350,exp:3650,actCount:1,acts:[act(1,35),act(43,15),act(251,25),act(158,25)],elmRes:{雷:40,風:-30},resists:{Poison:70,Shock:80}}),
    ...
    m({id:100081,name:'キラーマシン試作二号',race:'機械',rank:86,minF:86,hp:877,mp:67,atk:117,def:148,spd:107,mag:7,mdef:126,gold:5528,exp:6023,actCount:2,isElite:true,acts:[act(1,30),act(154,25),act(251,20),act(103,15),act(57,10)],drops:{normal:{id:14,rate:3},rare:{id:104,rate:1}},elmRes:{闇:30,雷:-40},resists:{Poison:90,Shock:40}}),
  ]},
  ...
  { bandStart: 91, bandEnd: 95, monsters: [
    ...
    m({id:100084,name:'イグナイトウルフ',race:'獣',rank:91,minF:91,hp:805,mp:0,atk:151,def:111,spd:126,mag:7,mdef:28,gold:4000,exp:4350,actCount:1,acts:[act(1,30),act(251,25),act(108,25),act(201,20)],elmRes:{雷:30,風:-30},resists:{Shock:50}}),
  ...
  { bandStart: 96, bandEnd: 100, monsters: [
    ...
    m({id:100087,name:'バトルマシーン',race:'機械',rank:96,minF:96,hp:854,mp:0,atk:154,def:163,spd:103,mag:7,mdef:129,gold:4800,exp:5200,actCount:1,acts:[act(1,30),act(154,25),act(158,20),act(103,15),act(51,10)],elmRes:{闇:30,雷:-50},resists:{Poison:90,Shock:50}}),
  ...
  { bandStart: 101, bandEnd: 105, monsters: [
    ...
    m({id:100093,name:'デスマシーン',race:'機械',rank:101,minF:101,hp:1065,mp:0,atk:165,def:168,spd:107,mag:7,mdef:136,gold:6000,exp:6500,actCount:1,acts:[act(1,25),act(154,20),act(158,20),act(401,20),act(251,15)],elmRes:{闇:30,雷:20,水:-20},resists:{Poison:100,Shock:60}}),
  ...
  { bandStart: 106, bandEnd: 110, monsters: [
    ...
    m({id:100098,name:'ダークウルフ',race:'獣',rank:106,minF:106,hp:965,mp:0,atk:169,def:105,spd:145,mag:7,mdef:28,gold:7200,exp:7600,actCount:1,acts:[act(1,25),act(108,20),act(205,20),act(211,25),act(703,10)],elmRes:{闇:20,風:20,光:-20,火:-20},resists:{Fear:30}}),
  ...
  { bandStart: 111, bandEnd: 115, monsters: [
    ...
    m({id:100101,name:'カオスアーマー',race:'無生物',rank:111,minF:111,hp:1241,mp:67,atk:178,def:183,spd:101,mag:89,mdef:157,gold:8500,exp:9000,actCount:1,acts:[act(1,25),act(153,15),act(401,20),act(117,20),act(51,20)],elmRes:{闇:30,光:20,雷:-30},resists:{Poison:100,Shock:50}}),
  ...
  { bandStart: 126, bandEnd: 130, monsters: [
    ...
    m({id:100116,name:'リリスナイト',race:'無生物',rank:126,minF:126,hp:1387,mp:87,atk:194,def:194,spd:107,mag:98,mdef:169,gold:14000,exp:14500,actCount:1,acts:[act(1,20),act(401,20),act(117,20),act(118,20),act(53,20)],elmRes:{闇:30,光:30,雷:-30},resists:{Poison:100,Shock:70}}),
    m({id:100117,name:'ウィスプロード',race:'精霊',rank:126,minF:126,hp:1559,mp:237,atk:8,def:103,spd:169,mag:163,mdef:194,gold:23100,exp:23925,actCount:2,isElite:true,acts:[act(1,15),act(423,20),act(408,20),act(410,20),act(905,15),act(57,10)],drops:{normal:{id:106,rate:1.5},rare:{id:107,rate:0.25}},elmRes:{闇:50,光:30,雷:30,混沌:-20},resists:{Poison:100,Seal:90}}),
  ]},
  ...
  { bandStart: 131, bandEnd: 135, monsters: [
    ...
    m({id:100120,name:'ガルヴァロス',race:'獣',rank:131,minF:131,hp:1289,mp:0,atk:201,def:129,spd:169,mag:7,mdef:44,gold:17000,exp:17500,actCount:1,acts:[act(1,20),act(211,25),act(205,20),act(206,20),act(703,15)],elmRes:{闇:30,風:20,火:-20,光:-20},resists:{Fear:50}}),
    m({id:100121,name:'アルカナソード',race:'無生物',rank:131,minF:131,hp:1458,mp:87,atk:199,def:199,spd:111,mag:105,mdef:176,gold:17000,exp:17500,actCount:1,acts:[act(1,20),act(401,20),act(118,20),act(414,20),act(51,20)],elmRes:{闇:40,光:20,雷:-30},resists:{Poison:100,Shock:70}}),
  ]},
  ...
  { bandStart: 136, bandEnd: 140, monsters: [
    ...
    m({id:100124,name:'ボルトアクス',race:'魔族',rank:136,minF:136,hp:1350,mp:67,atk:215,def:176,spd:133,mag:8,mdef:148,gold:20000,exp:21000,actCount:1,acts:[act(1,20),act(158,20),act(401,20),act(113,20),act(50,20)],elmRes:{雷:50,風:-30},resists:{Shock:90,Poison:70}}),
  ...
  { bandStart: 141, bandEnd: 145, monsters: [
    m({id:100127,name:'ネメシスユニット',race:'無生物',rank:141,minF:141,hp:1257,mp:67,atk:257,def:199,spd:107,mag:105,mdef:176,gold:23000,exp:24000,actCount:1,acts:[act(1,20),act(401,20),act(409,20),act(118,20),act(57,20)],elmRes:{闇:40,光:30,雷:-30},resists:{Poison:100,Shock:80}}),
    ...
    m({id:100130,name:'グリムレイス',race:'死霊',rank:141,minF:141,hp:1120,mp:194,atk:163,def:89,spd:157,mag:230,mdef:169,gold:23000,exp:24000,actCount:1,acts:[act(1,20),act(204,20),act(704,20),act(705,20),act(804,20)],elmRes:{闇:50,光:-40},resists:{Poison:100,Seal:80,InstantDeath:90}}),
  ]},

  { bandStart: 146, bandEnd: 150, monsters: [
    m({id:100131,name:'ドレッドノート',race:'機械',rank:146,minF:146,hp:1289,mp:0,atk:261,def:199,spd:129,mag:8,mdef:176,gold:26000,exp:27000,actCount:1,acts:[act(1,15),act(154,20),act(401,20),act(409,20),act(420,25)],elmRes:{闇:40,雷:-30,水:-20},resists:{Poison:100,Shock:80}}),
    ...
    m({id:100133,name:'ウロボロス',race:'粘体',rank:146,minF:146,hp:1312,mp:194,atk:199,def:169,spd:79,mag:235,mdef:169,gold:26000,exp:27000,actCount:1,acts:[act(1,15),act(405,20),act(410,20),act(414,20),act(53,25)],elmRes:{火:30,闇:40,光:20,雷:-30},resists:{Poison:100,Seal:70}}),
  ...
  { bandStart: 151, bandEnd: 155, monsters: [
    ...
    m({id:100137,name:'ルインシェイド',race:'無生物',rank:151,minF:151,hp:1526,mp:87,atk:297,def:220,spd:141,mag:105,mdef:194,gold:30000,exp:32000,actCount:1,acts:[act(1,15),act(102,10),act(409,20),act(421,10),act(118,20),act(414,25)],elmRes:{光:40,闇:40,雷:-30},resists:{Poison:100,Shock:90,Seal:70}}),
    ...
    m({id:100139,name:'エレシュキガル',race:'死霊',rank:151,minF:151,hp:1273,mp:250,atk:182,def:98,spd:188,mag:289,mdef:205,gold:30000,exp:32000,actCount:1,acts:[act(1,15),act(47,10),act(423,20),act(704,15),act(805,10),act(922,30)],elmRes:{闇:70,混沌:30,光:-50},resists:{Poison:100,Seal:90,InstantDeath:100}}),
  ]},

  { bandStart: 156, bandEnd: 160, monsters: [
    m({id:100140,name:'竜将ダハーカ',race:'竜人',rank:156,minF:156,hp:1591,mp:209,atk:304,def:199,spd:169,mag:199,mdef:194,gold:35000,exp:37000,actCount:1,acts:[act(1,15),act(103,10),act(409,20),act(213,20),act(615,20),act(901,15)],elmRes:{火:40,雷:30,光:30,闇:-30},resists:{Poison:100,Fear:90,Seal:70}}),
    m({id:100141,name:'ヴァルファング',race:'獣人',rank:156,minF:156,hp:1492,mp:0,atk:311,def:169,spd:194,mag:7,mdef:136,gold:35000,exp:37000,actCount:1,acts:[act(1,15),act(211,15),act(212,20),act(206,20),act(617,20),act(909,10)],elmRes:{風:40,闇:30,光:-30},resists:{Fear:80,Poison:80}}),
    ...
    m({id:100144,name:'ラグナビースト',race:'獣人',rank:156,minF:156,hp:1909,mp:274,atk:239,def:220,spd:188,mag:248,mdef:220,gold:57750,exp:61050,actCount:2,isElite:true,acts:[act(1,10),act(425,20),act(426,20),act(908,20),act(500,10),act(57,10),act(90,10)],drops:{normal:{id:107,rate:0.3},rare:{id:106,rate:3}},elmRes:{火:50,闇:60,混沌:50,光:-20,雷:-20},resists:{Poison:100,Seal:120,Debuff:70,InstantDeath:100}}),
  ]},

  { bandStart: 161, bandEnd: 165, monsters: [
    m({id:100145,name:'牙王マルバス',race:'獣',rank:161,minF:161,hp:1684,mp:0,atk:261,def:169,spd:210,mag:8,mdef:73,gold:42000,exp:44000,actCount:1,acts:[act(1,15),act(108,10),act(212,25),act(206,20),act(617,20),act(909,10)],elmRes:{風:50,闇:30,火:-20,光:-20},resists:{Fear:90}}),
    m({id:100146,name:'災厄機兵ヴリトラ',race:'機械',rank:161,minF:161,hp:1855,mp:87,atk:266,def:248,spd:148,mag:94,mdef:199,gold:42000,exp:44000,actCount:1,acts:[act(1,15),act(154,10),act(401,20),act(409,20),act(420,20),act(431,15)],elmRes:{闇:40,光:20,雷:-50},resists:{Poison:120,Shock:100,Seal:70}}),
  ...
  { bandStart: 166, bandEnd: 170, monsters: [
    ...
    m({id:100152,name:'シャドウマシーン',race:'機械',rank:166,minF:166,hp:1855,mp:67,atk:266,def:248,spd:176,mag:8,mdef:199,gold:50000,exp:52000,actCount:1,acts:[act(1,15),act(154,10),act(420,20),act(206,20),act(431,15),act(57,20)],elmRes:{闇:60,雷:-50},resists:{Poison:120,Shock:100}}),
  ...
  { bandStart: 181, bandEnd: 185, monsters: [
    ...
    m({id:100165,name:'デスアーマー',race:'無生物',rank:181,minF:181,hp:2774,mp:87,atk:318,def:297,spd:141,mag:105,mdef:239,gold:85000,exp:90000,actCount:1,acts:[act(1,10),act(117,10),act(421,15),act(431,15),act(118,25),act(57,25)],elmRes:{闇:50,光:50,混沌:30,雷:-30},resists:{Poison:150,Shock:120,Seal:100}}),
  ...
  { bandStart: 186, bandEnd: 190, monsters: [
    ...
    m({id:100169,name:'機神アマデウス',race:'機械',rank:186,minF:186,hp:2951,mp:87,atk:332,def:311,spd:199,mag:8,mdef:248,gold:100000,exp:105000,actCount:1,acts:[act(1,10),act(154,10),act(420,20),act(431,15),act(432,10),act(401,35)],elmRes:{闇:50,光:40,雷:-50},resists:{Poison:150,Shock:150,Seal:100}}),
  ...
  { bandStart: 191, bandEnd: 195, monsters: [
    ...
    m({id:100175,name:'混沌装甲アケローン',race:'無生物',rank:191,minF:191,hp:3367,mp:87,atk:364,def:332,spd:148,mag:115,mdef:282,gold:120000,exp:130000,actCount:1,acts:[act(1,10),act(117,10),act(411,20),act(421,15),act(432,10),act(57,35)],elmRes:{闇:60,光:60,混沌:50,雷:-30},resists:{Poison:150,Shock:150,Seal:120}}),
  ]},
  ...
  { bandStart: 196, bandEnd: 200, monsters: [
    ...
    m({id:100177,name:'獄機ヘルマジンガ',race:'機械',rank:196,minF:196,hp:3543,mp:87,atk:364,def:364,spd:199,mag:8,mdef:311,gold:150000,exp:160000,actCount:1,acts:[act(1,10),act(420,10),act(431,15),act(432,10),act(409,25),act(57,30)],elmRes:{闇:60,光:60,雷:-50,混沌:40},resists:{Poison:150,Shock:150,Seal:150}}),
    m({id:100178,name:'ウロボロスロード',race:'粘体',rank:196,minF:196,hp:3543,mp:387,atk:210,def:311,spd:105,mag:351,mdef:297,gold:150000,exp:160000,actCount:1,acts:[act(1,10),act(405,10),act(908,20),act(911,20),act(901,20),act(999,5),act(53,15)],elmRes:{混沌:70,闇:60,光:40,火:40,雷:-30},resists:{Poison:150,Seal:150,InstantDeath:120}}),
