...
const StoryManager = {
	...
	scripts: {
        ...
        "STORY_WIND_CLEAR": [
                {
                        "name": "エリーゼ",
                        "text": "風が、泣いていない……大人たちも、少しずつ目を覚ましている。",
                        "charId": 106
                },
                {
                        "name": "集落の長",
                ...
                {
                        "name": "エリーゼ",
                        "text": "ここで待っているだけでは、また誰かが奪われる。私も行きます。風の行き先を、最後まで見届けたい。",
                        "charId": 106
                }
        ],
        "STORY_WATER_CLEAR": [
        ...
        "WIND_VILLAGE_INTRO": [
                ...
                {
                        "name": "エリーゼ",
                        "text": "あなたたち、旅の人？　大人たちは……朝になったら、みんないなくなっていました。",
                        "charId": 106
                },
                {
                        "name": "子ども",
                ...
                {
                        "name": "エリーゼ",
                        "text": "禁忌の森は、昔は聖域でした。でもプリズム崩壊の日から魔物があふれて、封じるしかなくなった。森へ行くなら、案内が必要です。私も行きます。",
                        "charId": 106
                },
                {
                        "name": "システム",
        ...
        "SEABED_SYRIS_ENCOUNTER": [
                {
                        "name": "システム",
                        "text": "祈祷の間は凍てつき、侵入者を拒んでいるようだ。プリズムの青い光は薄れ、床一面に霜が広がっている。"
                },
                {
                        "name": "氷楔のシーリス",
        ...
        "LIGHTHOUSE_MIDBOSS_ENCOUNTER": [
                {
                        "name": "エリーゼ",
                        "text": "この炉から、神殿を包む結界の風が吹いています。でも……風に混じって、魔物の息がする。",
                        "charId": 106
                },
                {
                        "name": "ヘルクラッシャー",
