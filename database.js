	...
	SKILL_TREES : {
		...
		ATK: {
			...
			steps: [
				...
				{ desc: '攻撃力 +15%', stats: { atkMult: 0.05 }, skillId: 113 },
				{ desc: '攻撃力 +20%', stats: { atkMult: 0.05 }, skillId: 132 },
		...
		MAG: {
			...
			steps: [
				...
				{ desc: '魔力 +15%', stats: { magMult: 0.05 }, skillId: 209 },
				{ desc: '魔力 +20%', stats: { magMult: 0.05 }, skillId: 213 },
		...
		SPD: {
			...
			steps: [
				...
				{ desc: '素早さ +15%', stats: { spdMult: 0.05 }, skillId: 101 },
		...
		HP: {
			...
			steps: [
				...
				{ desc: '最大HP +30%', stats: { hpMult: 0.10 }, skillId: 404 },
				{ desc: '最大HP +40%', stats: { hpMult: 0.10 }, skillId: 407 },
		...
		MP: {
			...
			steps: [
				...
				{ desc: 'MP・防御・魔防 +15%', stats: { mpMult: 0.05, defMult: 0.05 }, skillId: 403 },
				{ desc: 'MP・防御・魔防 +20%', stats: { mpMult: 0.05, defMult: 0.05 }, skillId: 503 },
...
const DB = {
    ...
    MEDAL_REWARDS: [
        { medals: 2, name: '上やくそう x3', type: 'item', id: 2, count: 3 },
        { medals: 2, name: '魔法の小瓶 x5', type: 'item', id: 3, count: 5 },
        { medals: 4, name: '世界樹の葉 x1', type: 'item', id: 5, count: 1 },
        { medals: 5, name: 'エルフの飲み薬 x1', type: 'item', id: 7, count: 1 },
        { medals: 6, name: '世界樹の雫 x1', type: 'item', id: 6, count: 1 },
        { medals: 3, name: '業火の壺 x1', type: 'item', id: 1001, count: 1 },
        { medals: 3, name: '激流の壺 x1', type: 'item', id: 1006, count: 1 },
        { medals: 3, name: '迅雷の壺 x1', type: 'item', id: 1011, count: 1 },
        { medals: 3, name: '暴風の壺 x1', type: 'item', id: 1016, count: 1 },
        { medals: 3, name: '聖光の壺 x1', type: 'item', id: 1021, count: 1 },
        { medals: 3, name: '冥闇の壺 x1', type: 'item', id: 1026, count: 1 },
        { medals: 3, name: '崩界の壺 x1', type: 'item', id: 1031, count: 1 },
        { medals: 5, name: '鳳凰の火筒 x1', type: 'item', id: 1004, count: 1 },
        { medals: 5, name: '水龍の逆鱗 x1', type: 'item', id: 1009, count: 1 },
        { medals: 5, name: '雷神太鼓 x1', type: 'item', id: 1014, count: 1 },
        { medals: 5, name: '風神の扇 x1', type: 'item', id: 1019, count: 1 },
        { medals: 5, name: '天使の聖印 x1', type: 'item', id: 1024, count: 1 },
        { medals: 5, name: '魔王の瞳 x1', type: 'item', id: 1029, count: 1 },
        { medals: 5, name: '神喰の緋月石 x1', type: 'item', id: 1034, count: 1 },
        { medals: 5, name: '鷹眼の秘薬 x1', type: 'item', id: 1061, count: 1 },
        { medals: 5, name: '幻影の秘薬 x1', type: 'item', id: 1062, count: 1 },
        { medals: 10, name: '神霊の雫 x1', type: 'item', id: 1043, count: 1 },
        { medals: 20, name: 'メタルロードの鎧・レプリカ', type: 'equip', equipId: 901 },
        { medals: 20, name: 'メタルロードの盾・レプリカ', type: 'equip', equipId: 902 },
        { medals: 20, name: 'メタルロードの兜・レプリカ', type: 'equip', equipId: 903 },
