...
const themeDecorByTheme = {
    ...
    WATER_CITY: 'overlay_decor_water_city_puddle',
    ...
    CRENA_CAVE: 'overlay_decor_crena_limestone_pool',
...
for (const theme of tileThemeKeys) {
    if (!themeDecorByTheme[theme]) errors.push(`tile theme has no unique floor decoration: ${theme}`);
}
...
for (const marker of [
    ...
    'drawConnectedCastleCarpet', 'overlay_castle_carpet_fill',
