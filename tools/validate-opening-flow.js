...
if (mainSource.includes("fullDataCacheName: 'prisma-abyss-v3.85-blocking-map-objects-runtime-assets'") === false) {
    errors.push('main.js full cache version is not the current full-cache version');
}
if (!swSource.includes('const RUNTIME_CACHE_NAME = "prisma-abyss-v3.85-blocking-map-objects-runtime-assets"')) {
